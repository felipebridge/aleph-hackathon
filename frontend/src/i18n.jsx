...
const STRINGS = {
  en: {
    ...
    'switch.owner': 'Business Owner',
    'switch.accountant': 'Accountant',
    'switch.ownerDesc': 'Full business performance',
    'switch.accountantDesc': 'Accounting & ledger',
    'switch.active': 'Active',
    'notif.title': 'Notifications',
    'notif.markAll': 'Mark all as read',
    'notif.empty': 'No notifications',
    'notif.1.title': 'Receipt uploaded successfully',
    'notif.1.body': 'Uber_receipt.pdf was processed and classified as an expense.',
    'notif.2.title': 'Invoice attached from WhatsApp',
    'notif.2.body': 'A new invoice from Delta Logistica SA was received and added to the ledger.',
    'notif.3.title': 'Anomaly detected',
    'notif.3.body': 'Invoice TX-0030 has an inconsistent VAT amount — review recommended.',
    'notif.4.title': 'Receipt uploaded successfully',
    'notif.4.body': 'Factura_ZIRA.png was read by the AI and registered as income.',
    'notif.5.title': 'Monthly reconciliation ready',
    'notif.5.body': 'July 2026 closed with a positive result. 3 items need review.',
    'notif.ago.min': 'min ago',
    'notif.ago.hour': 'h ago',
    'notif.ago.day': 'd ago',
  },
  es: {
    ...
    'switch.title': 'Cambiar cuenta',
    'switch.owner': 'Dueño de Empresa',
    'switch.accountant': 'Contador',
    'switch.ownerDesc': 'Rendimiento completo del negocio',
    'switch.accountantDesc': 'Contabilidad y libro mayor',
    'switch.active': 'Activo',
    'notif.title': 'Notificaciones',
    'notif.markAll': 'Marcar todas como leídas',
    'notif.empty': 'Sin notificaciones',
    'notif.1.title': 'Recibo subido correctamente',
    'notif.1.body': 'Uber_receipt.pdf fue procesado y clasificado como egreso.',
    'notif.2.title': 'Factura adjuntada desde WhatsApp',
    'notif.2.body': 'Se recibió una nueva factura de Delta Logistica SA y se agregó al libro mayor.',
    'notif.3.title': 'Anomalía detectada',
    'notif.3.body': 'La factura TX-0030 tiene un IVA inconsistente — se recomienda revisar.',
    'notif.4.title': 'Recibo subido correctamente',
    'notif.4.body': 'Factura_ZIRA.png fue leída por la IA y registrada como ingreso.',
    'notif.5.title': 'Conciliación mensual lista',
    'notif.5.body': 'Julio 2026 cerró con resultado positivo. 3 ítems requieren revisión.',
    'notif.ago.min': 'min',
    'notif.ago.hour': 'h',
    'notif.ago.day': 'd',
  },
